...
const descriptions = {
    ...
    'False Scarcity and phantom pricing': 'Given a high and then cancel it and shown very less price compaired to old price',
    ...
    'Drip Pricing': 'misleads using cutting down the price and decreases the price'
};
            ...
            if (old_count === count){
                ...
                for (var h = 0; h < script_inner_content.length; h++) {
                    ...
                    if (script_content.includes("random")){
                        ...
                        if (is_timer && found) {
                            count++;
                            highlight(elements[i], 'False Scarcity and phantom pricing');
                            break;
                        }
                    }
                }
    ...
    async function(request, sender, sendResponse) {
        ...
        if (request.message === 'analyze_site') {
            ...
            if (request.sentence_encode === 'DARK') {
                // highlight(elements[request.index], 'False Scarcity and phantom pricing');
